...
export const LANG = {
  zh: {
    ...
    neuralProcessing: '◈ 本地战术分析...',
    actionSynthesis: '◈ 确定性行动校验...',
    resolvingAction: '⏳ 正在执行本地规则...',
    ...
    keyDecisionNode: '⏸ 关键决策节点 — 战术分析完成，等待指挥官选择调查方向',
    ...
    riskSteadyDesc: '规则系统根据当前公开线索链给出的稳健推进方案',
  ...
  en: {
    ...
    neuralProcessing: '◈ LOCAL TACTICAL ANALYSIS...',
    actionSynthesis: '◈ DETERMINISTIC ACTION VALIDATION...',
    resolvingAction: '⏳ Executing local rules...',
    ...
    keyDecisionNode: '⏸ KEY DECISION NODE — Tactical analysis complete; choose the next investigative direction',
