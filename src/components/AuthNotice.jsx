...
const COPY = {
  zh: {
    ...
    backend_mismatch: '网页与 Worker 的 Firebase 项目不一致，请管理员统一部署配置。',
    config_missing: '身份服务尚未完成配置，请联系管理员。',
    domain_unauthorized: '当前域名尚未获得 Firebase 授权，请联系管理员。',
    provider_disabled: '该登录方式尚未在 Firebase 启用。',
    browser_unsupported: '当前浏览器无法安全保存登录状态，请更换浏览器或调整隐私设置。',
    rate_limited: '操作过于频繁，请稍后再试。',
    github_cancelled: 'GitHub 授权已取消。',
    action_expired: '认证链接无效或已过期，请重新发起操作。',
  ...
  en: {
    ...
    backend_mismatch: 'The web app and Worker use different Firebase projects. Align the deployment configuration.',
    config_missing: 'Authentication is not configured. Contact an administrator.',
    domain_unauthorized: 'This domain is not authorized in Firebase. Contact an administrator.',
    provider_disabled: 'This sign-in provider is not enabled in Firebase.',
    browser_unsupported: 'This browser cannot persist a secure session. Adjust its privacy settings or use another browser.',
    rate_limited: 'Too many attempts. Wait and try again.',
    github_cancelled: 'GitHub authorization was cancelled.',
    action_expired: 'The authentication link is invalid or expired. Start the action again.',
