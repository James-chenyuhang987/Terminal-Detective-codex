...
const TX = {
  zh: {
    ...
    tutorial: '调查新手教程', tutorialDesc: '每次进入调查终端时显示完整六步教程',
    av: '音效与视觉 · AUDIO & FX',
  ...
  en: {
    ...
    tutorial: 'Investigation Tutorial', tutorialDesc: 'Show the complete six-step guide whenever the investigation terminal opens',
    av: 'AUDIO & FX',
