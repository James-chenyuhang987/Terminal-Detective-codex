...
export const SYNERGY_SKILLS = [
  {
    id: 'cross_validation',
    name: '交叉验证',
    nameEn: 'CROSS VALIDATION',
    icon: '🔗',
    color: '#00e5ff',
    condition: 'NEXUS 逻辑≥30 + AURORA 观察≥30',
    conditionEn: 'NEXUS Logic ≥30 + AURORA Observation ≥30',
    desc: '推理连线难度降低，AI 更容易认可线索间的逻辑关联',
    descEn: 'Reduces deduction-link difficulty so the AI recognizes valid evidence relationships more easily',
  ...
  },
  {
    ...
    conditionEn: 'CIPHER Hack ≥30 + AURORA Observation ≥30',
    desc: '法证/黑客类行动线索发现率 +20%',
    descEn: 'Increases clue discovery from forensic and hacking actions by 20%',
  ...
  },
  {
    ...
    conditionEn: 'CIPHER Hack ≥30 + NEXUS Anti-Chaos ≥25',
    desc: '危机事件惩罚额外降低 20%',
    descEn: 'Reduces crisis-event penalties by an additional 20%',
